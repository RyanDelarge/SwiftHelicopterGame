...
struct ContentView: View {
    ...
    func collisionDetection() {
        // Collision formula: x < pixelSize * helicopterRows / 2, y < obstacleWidth / 2
        if abs(heliPosition.x - obstPosition.x) < (24 + 10) && abs(heliPosition.y - obstPosition.y) < (10 + 100) || heliPosition.y == 0 || heliPosition.y == 400 {
            self.pause()
